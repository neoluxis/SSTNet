...
def parse_args():
    parser = argparse.ArgumentParser(description="Train SSTNet on CST_AntiUAV or IRDST")
    parser.add_argument("--cuda", type=str2bool, default=True)
    parser.add_argument("--distributed", type=str2bool, default=False)
    parser.add_argument("--sync-bn", type=str2bool, default=False)
    parser.add_argument("--fp16", type=str2bool, default=False)
    parser.add_argument("--classes-path", type=str, default="model_data/classes.txt")
    parser.add_argument("--model-path", type=str, default="model_data/pre_trained.pth")
    parser.add_argument("--input-shape", type=int, nargs=2, default=[512, 512])
    parser.add_argument("--phi", type=str, default="s")
    parser.add_argument("--mosaic", type=str2bool, default=False)
    ...
    parser.add_argument("--freeze-epoch", type=int, default=100)
    parser.add_argument("--freeze-batch-size", type=int, default=16)
    parser.add_argument("--unfreeze-epoch", type=int, default=100)
...
if __name__ == "__main__":
    ...
    Min_lr              = args.min_lr if args.min_lr is not None else Init_lr * 0.01
    #------------------------------------------------------------------#
